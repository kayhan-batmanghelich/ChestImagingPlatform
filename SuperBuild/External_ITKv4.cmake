...
if(NOT DEFINED ITK_DIR AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  set(ITKv4_GIT_TAG 615607fe1498dfb85e69cbc719f52d7e9cf776de) # slicer-v4.8.2
  ...
  message("***** THIS ARE MY VARIABLES: ${CMAKE_OSX_DEPLOYMENT_TARGET}; ${CMAKE_OSX_SYSROOT}")
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      # -DCMAKE_OSX_SYSROOT:FILEPATH=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk
      -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=${CMAKE_OSX_DEPLOYMENT_TARGET}
      -DCMAKE_OSX_SYSROOT:FILEPATH=${CMAKE_OSX_SYSROOT}
